local function lsp_on_attach(_, bufnr)
    ...
    -- NOTE: These keymaps use Snacks.picker for LSP navigation. They live here rather than
    -- plugins/snacks/keymaps.lua because they belong to the on_attach callback and need
    -- the bufnr closure that nmap provides.
